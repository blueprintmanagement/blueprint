export type ExpenseType = "Material" | "Mao de Obra" | "Servico" | "Equipamento";
export type PaymentMethod = "PIX" | "Boleto" | "Cartao" | "A Prazo";
...
export const projects: Project[] = [
  {
    ...
    phases: [
      ...
      { id: "vivaldino-fundacao", name: "Fundacao", budget: 92000 },
      ...
      { id: "vivaldino-mao-obra", name: "Mao de obra contratada", budget: 393332.4 },
    ],
  },
  {
    id: "project-alpha",
    ...
    phases: [
      { id: "alpha-fundacao", name: "Fundacao", budget: 180000 },
  ...
  },
  {
    ...
    phases: [
      ...
      { id: "serena-instalacoes", name: "Instalacoes", budget: 128000 },
    ],
  },
];

export const suppliers: Supplier[] = [
  { id: "supplier-armelio", name: "Armelio Ribeiro", document: "CPF nao informado", category: "Servico", contact: "(51) 99900-1122" },
  { id: "supplier-marcelo", name: "Marcelo Terraplanagem", document: "CNPJ nao informado", category: "Servico", contact: "(51) 99821-3300" },
  { id: "supplier-taqi", name: "Taqi", document: "92.012.467/0001-70", category: "Material", contact: "loja@taqi.com.br" },
  { id: "supplier-minuano", name: "Minuano", document: "CNPJ nao informado", category: "Material", contact: "vendas@minuano.com.br" },
  { id: "supplier-pedreira", name: "Pedreira Lindenmeier", document: "CNPJ nao informado", category: "Material", contact: "(51) 3333-1000" },
  { id: "supplier-nathan", name: "Nathan", document: "CPF nao informado", category: "Mao de Obra", contact: "(51) 99920-0303" },
  { id: "supplier-duarte", name: "Madeireira Duarte", document: "CNPJ nao informado", category: "Material", contact: "(51) 3339-8800" },
  { id: "supplier-contabilidade", name: "Contabilidade.imob", document: "CNPJ nao informado", category: "Servico", contact: "financeiro@contabilidade.imob" },
  { id: "supplier-lacerda", name: "Lacerda", document: "CNPJ nao informado", category: "Material", contact: "(51) 3300-4500" },
  { id: "supplier-joao", name: "Empreiteiro Joao Santos", document: "087.214.456-92", category: "Mao de Obra", contact: "(31) 98824-1102", bankInfo: "Pix CPF 087.214.456-92" },
  { id: "supplier-hidrovale", name: "Hidrovale Instalacoes", document: "28.551.740/0001-39", category: "Servico", contact: "notas@hidrovale.com.br" },
];

export const catalogItems: CatalogItem[] = [
  { id: "item-limpeza-terreno", name: "Limpeza de terreno", type: "Servico", unit: "servico", referencePrice: 500 },
  { id: "item-terraplanagem", name: "Terraplanagem", type: "Servico", unit: "hora", referencePrice: 250 },
  ...
  { id: "item-mao-obra-semanal", name: "Pagamento semanal mao de obra", type: "Mao de Obra", unit: "semana", referencePrice: 4500 },
  { id: "item-diaria-pedreiro", name: "Diaria de pedreiro", type: "Mao de Obra", unit: "diaria", referencePrice: 260 },
  { id: "item-diaria-servente", name: "Diaria de servente", type: "Mao de Obra", unit: "diaria", referencePrice: 160 },
  { id: "item-eletricista", name: "Diaria de eletricista", type: "Mao de Obra", unit: "diaria", referencePrice: 320 },
  { id: "item-instalacao-hidraulica", name: "Servico de instalacao hidraulica", type: "Servico", unit: "servico", referencePrice: 2320 },
  { id: "item-instalacao-eletrica", name: "Servico de instalacao eletrica", type: "Servico", unit: "servico", referencePrice: 1850 },
  { id: "item-locacao-betoneira", name: "Locacao de betoneira 400L", type: "Equipamento", unit: "dia", referencePrice: 95 },
  { id: "item-locacao-andaime", name: "Locacao de andaime", type: "Equipamento", unit: "semana", referencePrice: 380 },
...
export const expenses: Expense[] = [
  ...
  },
  {
    ...
    description: "Pagamento semanal mao de obra",
    type: "Mao de Obra",
    quantity: 1,
    unitValue: 4500,
    total: 4500,
  ...
  },
  {
    ...
    description: "Servico de instalacao hidraulica",
    type: "Servico",
    quantity: 1,
    unitValue: 2320,
    total: 2320,
